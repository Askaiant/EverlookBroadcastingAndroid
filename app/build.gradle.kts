...
android {
    namespace = "org.everlookkbroadcasting.android"
    compileSdk = 35
    ...
    buildTypes {
        ...
        release {
            ...
            val shakeApiKey: String? = gradleLocalProperties(rootDir, providers).getProperty("SHAKE_API_KEY")
            if (shakeApiKey != null) {
                buildConfigField("String", "SHAKE_API_KEY", "\"$shakeApiKey\"")
            } else {
                throw GradleException("SHAKE_API_KEY variable is not set")
            }
            proguardFiles(
